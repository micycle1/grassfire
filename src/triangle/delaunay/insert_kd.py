...
from triangle.delaunay.tds import box, ccw, apex, orig, dest, InfiniteVertex, \
    Vertex, Triangle, Triangulation
from triangle.delaunay.preds import orient2d, incircle
from triangle.delaunay.cdt import ConstraintInserter
from triangle.delaunay.iter import FiniteEdgeIterator, StarEdgeIterator
from triangle.delaunay.inout import output_vertices, output_triangles
...
#     segments = [(0, 3)]
# #     from triangle.delaunay.helpers import random_circle_vertices
